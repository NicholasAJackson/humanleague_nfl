...
- `/trades` — **Trade analyzer** (redraft Half-PPR): DynastyProcess ECR → trade points, Side A vs Side B fairness band, optional package adjust, **starter-upgrade** deltas (optimal 1QB/2RB/2WR/1TE/1FLEX/1DST lineup), and a **trade finder** that suggests mutual-upgrade deals from linked Sleeper rosters.
